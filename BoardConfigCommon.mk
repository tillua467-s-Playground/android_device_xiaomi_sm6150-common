...
# Partitions
-include vendor/$(VENDOR_TARGET_DIR)/config/BoardConfigReservedSize.mk
...
include device/$(VENDOR_TARGET_DIR)/sepolicy/libion/sepolicy.mk
include device/$(VENDOR_TARGET_DIR)/sepolicy/libperfmgr/sepolicy.mk
